              ...
              style="width:35%; margin-top:-35px" alt="">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-menu">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="<?php echo PUERTO."://".HOST;?>/">Inicio</a></li>                    
                            <li><a href="#" data-toggle="modal" data-target="#myModal">Candidato</a></li>
                            <li>
              
              <a href="#" data-toggle="modal" data-target="#myModal2">Empresa</a></li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                    <?php }else{ ?>
                    <div class="collapse navbar-collapse" id="navbar-menu">
                            ...
                            <?php if ($rol==1) {
                                ...
                                if ($ff1 == '')
                                {
                                    if ($rec2 >=1) {
                                            if ($rec1 >=1)
                                        {
                                            $redirect_url = "ttest.php";
                                            $text = "Continuar Inf. #3";
                                        }
                                        else
                                        {
                                            $redirect_url = "planes_usuario.php";
                                            $text = "Mi cuestionario 3";
                                        }

                                        if ($ff1!='' || $ff1 == null) {
                                                    
                                            ?>
                                            <li><a href="<?php echo $redirect_url ?>"><p style="text-shadow: 0 0 30px red; font-weight: 900; color: cyan;"><?php echo $text; ?></p></a></li>
                                            <?php
                             ...
                             ?>
                            <li><a href="oportunidades.php">Empleos</a></li>
                            <li><a href="postulaciones.php">Mis Postulaciones</a></li>
                            <?php }else{ ?>
                            <li><a href="publicar-vacante.php">Publicar Vacantes</a></li>
                            <li><a href="misvacantes.php">Mis Vacantes</a></li>
                            <?php } ?>
                            
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo $nombres ?> 
                              <ul class="dropdown-menu">
                                <li><a href="facturas.php">Mis facturas</a></li>
                                ...
                                <li><a href="planes_usuario.php">Mis planes</a></li>
                                    
                                    <?php
                                        }
                                    }
                                    ?>
                                <li><a href="tools_user.php">Configuración</a></li>
